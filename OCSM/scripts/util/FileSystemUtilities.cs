...
public class FileSystemUtilities
{
	...
	/// </remarks>
	public static string DefaultSheetDirectory
		=> createPathIfNotExists(autoLower(getFinalPath(Environment.SpecialFolder.ApplicationData, Sheets)));
	...
	/// </remarks>
	public static string DefaultMetadataDirectory
		=> createPathIfNotExists(autoLower(getFinalPath(Environment.SpecialFolder.CommonApplicationData, Metadata)));
