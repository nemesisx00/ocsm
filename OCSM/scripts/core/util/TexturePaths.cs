...
public static class TexturePaths
{
	...
	public const string TrackBox2 = $"{Prefix}/slash-two.png";
	public const string TrackBox3 = $"{Prefix}/slash-three.png";
	public const string TrackCircle = $"{Prefix}/circle-empty.png";
