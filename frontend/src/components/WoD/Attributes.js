		...
		return (
			<div className="attributesWrapper">
				...
				<div className="attributes">
					...
					<div className="column">
						<Tracker keyWord="presence" className="spacer dots presence" type={Tracker.Types.Circle} max={this.props.max} value={this.props.attributes.presence} changeHandler={(arg) => this.props.changeHandler(arg, 'presence')} />
